...
>
> <a href="https://www.tandfonline.com/doi/full/10.1080/14036096.2022.2094460" target="_blank" rel="noopener noreferrer">Line Kryger Aagaard</a>’s work has shown that the smart home experience is often gendered, too. Annika’s own research on <a href="https://dl.acm.org/doi/10.1007/978-3-031-42286-7_17" target="_blank" rel="noopener noreferrer">cohabitation in smart homes</a> explored this directly, looking at what happens when one person sets up and maintains the technology while the other lives with it, and finding power imbalances that require couples to negotiate control. It’s a dynamic we’re actively working to redesign for (for example, see ongoing UX design discussions on “<a href="https://github.com/OpenHomeFoundation/ux-design/discussions/40" target="_blank" rel="noopener noreferrer">Home Assistant for the whole household</a>”), not just between partners but across every relationship in the home.
