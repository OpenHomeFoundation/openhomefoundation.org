...
We’ve made some exciting changes this year, so read on for a sneak peek 👀
...
Since Luma has honored your contact preferences, we can’t rely on it to reach out to everyone who hosted a meetup for last year’s Community Day. So if that’s you, [please contact us](mailto:community@openhomefoundation.org)! We’ve created a <a href="https://discord.com/channels/330944238910963714/1537054268933144677" target="_blank" rel="noopener noreferrer">Discord channel</a> for you to post in and we want to make sure you have a role specific to your, well, role in meetups!

And on the subject of supporting hosts, there’s a lot that’s new this year to ensure your day runs smoothly. We’ll have a dedicated website that will update dynamically when new meetups are added to the Luma calendar, with updated reimbursement guidelines, a merch request form, and a Host Playbook for guidance on hosting your local meetup 👏

## Let’s get specific… in September

In early September, we’ll have all the details ready for you, including opening up submissions on the Community Day Luma calendar, all the graphic assets, and the event’s website up and running for everyone to get started. Just let us get through [IFA Berlin](/blog/ifa-berlin-2026-save-the-date/) first 😅
